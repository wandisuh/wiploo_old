	  ...
	  <!--<div class="col-md-12 col-xs-12">-->
		<div class="x_panel">
		  ...
		  <div class="x_content">
			...
			<form class="form-horizontal form-label-left" method="POST" action="<?php echo e(route('store-article')); ?>" enctype="multipart/form-data">
				<?php echo e(csrf_field()); ?>

			  <div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Judul Artikel</label>
				<div class="col-md-5 col-sm-9 col-xs-12">
				  <input type="text" class="form-control" value="<?php echo e(old('title')); ?>" name="title" required>
				</div>
			  </div>
			  <div class="form-group">
			  ...
			  <div class="form-group">
				...
				<div class="col-md-4 col-sm-9 col-xs-12">
				  <input type="file" class="form-control" value="<?php echo e(old('image')); ?>" name="image" required>
				</div>
			  </div>
			  <div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Konten Pendek</label>
				<div class="col-sm-10 col-xs-12">
				  <textarea name="short_content" class="form-control" required><?php echo e(old('short_content')); ?></textarea>
				</div>
			  </div>
			  <div class="form-group">
				<label class="control-label col-md-2 col-sm-3 col-xs-12">Konten</label>
				<div class="col-sm-10 col-xs-12">
				  <textarea id="editor" name="content" required><?php echo e(old('content')); ?></textarea>
				</div>
			  </div>
