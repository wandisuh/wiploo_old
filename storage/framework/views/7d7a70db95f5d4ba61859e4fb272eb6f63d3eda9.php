...
<html class="no-js">
    <head>
        ...
        <!-- Ionicons Fonts Css -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/ionicons.min.css')); ?>">
        <!-- animate css -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/animate.css')); ?>">
        <!-- Hero area slider css-->
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/slider.css')); ?>">
        <!-- owl craousel css -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/owl.carousel.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/owl.theme.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/jquery.fancybox.css')); ?>">
        <!-- template main css file -->
        <link rel="stylesheet" href="<?php echo e(asset('assets/frontend/assets/css/main.css')); ?>">
        <!-- responsive css -->
        ...
        ================================================== -->
        <!-- modernizr js -->
        <script src="<?php echo e(asset('assets/frontend/assets/js/vendor/modernizr-2.6.2.min.js')); ?>"></script>
        <!-- jquery -->
        <script src="<?php echo e(asset('assets/frontend/assets/jquery.min.js')); ?>"></script>
        <!-- owl carouserl js -->
        <script src="<?php echo e(asset('assets/frontend/assets/js/owl.carousel.min.js')); ?>"></script>
        <!-- bootstrap js -->

        <script src="<?php echo e(asset('assets/frontend/assets/js/bootstrap.min.js')); ?>"></script>
        <!-- wow js -->
        <script src="<?php echo e(asset('assets/frontend/assets/js/wow.min.js')); ?>"></script>
        <!-- slider js -->
        <script src="<?php echo e(asset('assets/frontend/assets/js/slider.js')); ?>"></script>
        <script src="<?php echo e(asset('assets/frontend/assets/js/jquery.fancybox.js')); ?>"></script>
        <!-- template main js -->
        <script src="<?php echo e(asset('assets/frontend/assets/js/main.js')); ?>"></script>
    </head>
    <body>
        <!--
        ==================================================
            ...
            <div class="container top-bar-container">
                <div class="navbar-header">
                    ...
                    <div class="navbar-brand">
                        <a href="index.php" >
                            <img src="<?php echo e(asset('assets/frontend/assets/images/logo.png')); ?>" alt="">
                        </a>
                    </div>
                    <!-- /logo -->
                </div>
				...
				<div class="top-banner vertical-padding">
						...
						<div class="main-sliders">
							<div class="main-slider-container">
								<div class="main-slider-image">
									<img src="<?php echo e(asset('assets/frontend/assets/images/newslide.jpg')); ?>" class="width-100">
								</div>
					...
					<div class="col-md-4 col-sm-4 no-padding">
						<div class="main-sliders side-banner">
							<div class="main-slider-container">
								<div class="main-slider-image">
									<img src="<?php echo e(asset('assets/frontend/assets/images/sidebanner.jpg')); ?>" class="width-100">
								</div>
								<div class="slider-title-container">
				...
				<div class="row">
						...
						<div class="col-md-6 col-sm-6">
							<div class="news-container">
								<div class="news-image">
									<img src="<?php echo e(asset('assets/frontend/assets/images/dummy.jpg')); ?>" class="img-responsive width-100" alt="dummy news image">
								</div>
					...
					<div class="col-md-3 col-sm-3">
						...
						<div class="ads-banner-container width-100 vertical-padding">
							<a href="#"><img src="<?php echo e(asset('assets/frontend/assets/images/square-ads.jpg')); ?>" class="width-100" /></a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="text-center">
				<div class="ads-banner-container width-100 ">
					<a href="#"><img src="<?php echo e(asset('assets/frontend/assets/images/horizontal-ads.jpg')); ?>" class="text-center" /></a>
				</div>
			</div>
		</div>
		<!--
							...
							<div class="col-md-12">
								<div class="video-content width-100">
									<!--video code goes here-->
										<img src="<?php echo e(asset('assets/frontend/assets/images/video-dummy.jpg')); ?>" class="width-100">
									<!--end-->
						...
						<div class="featured-news-container vertical-padding">
							...
							<div class="news-container">
								<div class="row">
									<div class="col-md-4">
										<div class="news-image">
											<img src="<?php echo e(asset('assets/frontend/assets/images/dummy-featured.jpg')); ?>" class="img-responsive width-100" alt="dummy news image">
										</div>
									</div>
									<div class="col-md-8">
										<p class="news-date"> Date, May 06th 2017</p>
